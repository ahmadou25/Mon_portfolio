...
const typed = new Typed('.multiple-text', {
    strings: ['apprenti développeur', 'étudiant en BTS SIO'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "a5e9a850-d900-4eb8-8c02-c70a19f78290",
        To: 'ahmadoudiawdiaw@gmail.com',
        From: "ahmadoudiawdiaws@gmail.com",
